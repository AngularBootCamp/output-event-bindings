# Angular Boot Camp example: output-event-bindings
...
**[StackBlitz for output-event-bindings](https://stackblitz.io/github/AngularBootCamp/output-event-bindings)**

Alternatively, you can clone the repository locally to run the example:

```
git clone git@github.com:AngularBootCamp/output-event-bindings.git
cd output-event-bindings
npm install
npm start
```
